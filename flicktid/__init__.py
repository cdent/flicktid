...
SET_URI = "http://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=%s&photoset_id=%s&extras=url_t%%2Curl_o%%2Curl_s%%2Curl_m&format=json&nojsoncallback=1"
...
def put_tiddler(options, url_type, photo):
    ...
    json_data = {'fields': {'_canonical_uri': photo_url}}
